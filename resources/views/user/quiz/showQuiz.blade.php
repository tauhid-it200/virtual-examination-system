...
<div class="row">
    <div class="col-lg-8 col-lg-offset-2">
            ...
            <div class="panel-heading">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{url("/save-quiz")}}">
                    ...
                    <input type="hidden" name="<?php echo 'correct_ans_'.$serialNo; ?>" value="<?php echo $rowQuestion -> correct_answer; ?>"/> 
                    <hr>
                    <?php $serialNo++; } ?>
